...
create table dsi_employee_attendance (employee_attendance_id varchar(40) not null, attendance_date datetime, check_in_time varchar(10), check_out_time varchar(10), is_absent bit, total_hour varchar(10), employee_id varchar(40), version integer, primary key (employee_attendance_id));
...
create table dsi_employee_designation (employee_designation_id varchar(40) not null, designation_date datetime, name varchar(50), employee_id varchar(40), is_current bit, version integer, primary key (employee_designation_id));
...
create table dsi_leave_request (leave_request_id varchar(40) not null, apply_date datetime, approval_id varchar(40), approved_date datetime, approved_days_count integer, approved_end_date datetime, approved_start_date datetime, days_count integer, denied_reason TEXT, end_date datetime, is_client_notify bit, last_modified_date datetime, leave_reason TEXT, start_date datetime, apply_id varchar(40), leave_status_id varchar(40), leave_type_id varchar(40), version integer, primary key (leave_request_id));
