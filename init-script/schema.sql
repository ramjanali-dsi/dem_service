...
create table dsi_employee_designation (employee_designation_id varchar(40) not null, designation_date datetime, name varchar(50), employee_id varchar(40), is_current bit, primary key (employee_designation_id));
